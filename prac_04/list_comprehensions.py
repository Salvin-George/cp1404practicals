...
# list comprehension to look at the last element in the split full names and checks if it is longer than 11 characters.
long_names = [name.split()[-1] for name in full_names if len(name.split()[-1]) > 11]
